        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-title h4">
                    <center>
                        Bitácora de operaciones (TR1/TR1-R)
                    </center>
                </div>
                <br>
            ...
            <div class="col-md-2">
                <div class="form-group form-group-default">
                    ...
                    <input  type="date" class="form-control input-with-border" id="dia" name="dia" value="{{ \Carbon\Carbon::now('America/Mexico_City')->format('Y-m-d') }}"
                     onchange="buscar()">
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $('#llegada_salida').on('change', function() {
        ...
        function buscar() {
            ...
            {
                $.ajax({
                    url: '{{ route("buscar_por_ciclo_tr1") }}',
                    data: { 
                        'ciclo': ciclo ,
                        'dia': dia ,
                        'llegada_salida': llegada_salida ,
                    ...
                    success: function (json) {
                        console.log(json['consulta'][ciclo-1]);
                        ...
                        if(json['consulta'].length>0)
                        {
                            ...
                            if (json['consulta'][ciclo-1] !== undefined) {
                                ...
                                if(llegada_salida==1)
                                {
                                    ...
                                    if(servicio=='TR1' || servicio=='TR1-R'){
                                ...
                                }else if(llegada_salida==2)
                                {
                                    ...
                                    if(hora_salida_2!== null){
                                        ...
                                        $('#hora_ll').val(json['consulta'][ciclo-1]['salida_mitad_recorrido'] - 2);
                                    }
