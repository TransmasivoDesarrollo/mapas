            ...
            <table class="table table-hover table-striped table-bordered display  "  id="list_user2">
                <thead>
                    <tr>
                        ...
                        <th class=" sorting" style="color:#ffffff; background-color:#872637; width: 23%;"><center>Salida 1</center></th>
                        <th class=" sorting" style="color:#ffffff; background-color:#872637; width: 21%;"><center>Llegada 1</center></th>
                        <th class=" sorting" style="color:#ffffff; background-color:#872637; width: 23%;"><center>Salida 2</center></th>
                        <th class=" sorting" style="color:#ffffff; background-color:#872637; width: 21%;"><center>Llegada 2</center></th>
                    </tr>
                </thead>
                <tbody id="llenaTabla" >
