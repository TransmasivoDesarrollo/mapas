							...
							<div class="form-group row " >
								...
								<div class="col-md-12">
									...
									<table width="100%;">
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="aceite_motor" name="aceite_motor" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="aceite_motor" name="aceite_motor" value="cambio"></td>
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="refrigerante" name="refrigerante" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="refrigerante" name="refrigerante" value="cambio"></td>
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="aceite_hidra" name="aceite_hidra" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="aceite_hidra" name="aceite_hidra" value="cambio"></td>
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="hidroven" name="hidroven" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="hidroven" name="hidroven" value="cambio"></td>
							...
							<div class="form-group row " >
								...
								<div class="col-md-12">
									...
									<table width="100%;">
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="servicio" name="servicio" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="servicio" name="servicio" value="cambio"></td>
											<td align="rigth">
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="emergencia" name="emergencia" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="emergencia" name="emergencia" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
							...
							<div class="form-group row " >
								...
								<div class="col-md-12">
									...
									<table width="100%;">
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="neu_eje_dir_izq" name="neu_eje_dir_izq" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="neu_eje_dir_izq" name="neu_eje_dir_izq" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="neu_eje_dir_der" name="neu_eje_dir_der" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="neu_eje_dir_der" name="neu_eje_dir_der" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
							...
							<div class="form-group row " >
								...
								<div class="col-md-12">
									...
									<table width="100%;">
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="neu_eje_motr_izq" name="neu_eje_motr_izq" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="neu_eje_motr_izq" name="neu_eje_motr_izq" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="neu_eje_motr_der" name="neu_eje_motr_der" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="neu_eje_motr_der" name="neu_eje_motr_der" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
							...
							<div class="form-group row " >
								...
								<div class="col-md-12">
									...
									<table width="100%;">
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="bal_eje_dir_izq" name="bal_eje_dir_izq" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="bal_eje_dir_izq" name="bal_eje_dir_izq" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="bal_eje_dir_der" name="bal_eje_dir_der" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="bal_eje_dir_der" name="bal_eje_dir_der" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
							...
							<div class="form-group row " >
								...
								<div class="col-md-12">
									...
									<table width="100%;">
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="bal_eje_motr_izq" name="bal_eje_motr_izq" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="bal_eje_motr_izq" name="bal_eje_motr_izq" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="bal_eje_motr_der" name="bal_eje_motr_der" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="bal_eje_motr_der" name="bal_eje_motr_der" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
							...
							<div class="form-group row " >
								...
								<div class="col-md-12">
									...
									<table width="100%;">
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="bols_air_eje_dir_izq" name="bols_air_eje_dir_izq" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="bols_air_eje_dir_izq" name="bols_air_eje_dir_izq" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="bols_air_eje_dir_der" name="bols_air_eje_dir_der" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="bols_air_eje_dir_der" name="bols_air_eje_dir_der" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
							...
							<div class="form-group row " >
								...
								<div class="col-md-12">
									...
									<table width="100%;">
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="bols_air_eje_motr_izq" name="bols_air_eje_motr_izq" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="bols_air_eje_motr_izq" name="bols_air_eje_motr_izq" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
										...
										<tr>
											<td align="center"><input type="radio" required class="form-control" id="bols_air_eje_motr_der" name="bols_air_eje_motr_der" value="ok" ></td>
											<td align="center"><input type="radio" required class="form-control" id="bols_air_eje_motr_der" name="bols_air_eje_motr_der" value="cambio"></td>
											<td align="rigth">
												<div class="form-check">
													@foreach($fallas as $falla)
						...
						<div class="form-group row " >
							...
							<div class="col-md-12">
								...
								<table width="100%;">
									...
									<tr>
										<td align="center"><input type="radio" required class="form-control" id="asiento_conductor" name="asiento_conductor" value="ok" ></td>
										<td align="center"><input type="radio" required class="form-control" id="asiento_conductor" name="asiento_conductor" value="cambio"></td>
										<td align="rigth">
											<div class="form-check">
												@foreach($fallas as $falla)
									...
									<tr>
										<td align="center"><input type="radio" required class="form-control" id="asiento_carro1" name="asiento_carro1" value="ok" ></td>
										<td align="center"><input type="radio" required class="form-control" id="asiento_carro1" name="asiento_carro1" value="cambio"></td>
										<td align="rigth">
											<div class="form-check">
												@foreach($fallas as $falla)
					...
					<div class="form-group row " >
						...
						<div class="col-md-12">
							...
							<table width="100%;">
								...
								<tr>
									<td align="center"><input type="radio" required class="form-control" id="calibracion_neum_granada" name="calibracion_neum_granada" value="ok" ></td>
									<td align="center"><input type="radio" required class="form-control" id="calibracion_neum_granada" name="calibracion_neum_granada" value="cambio"></td>
									<td align="rigth">
										<div class="form-check">
											@foreach($fallas as $falla)
					...
					<div class="form-group row " >
						...
						<div class="col-md-12">
							...
							<table width="100%;">
								...
								<tr>
									<td align="center"><input type="radio" required class="form-control" id="eje_dir_izq" name="eje_dir_izq" value="ok" ></td>
									<td align="center"><input type="radio" required class="form-control" id="eje_dir_izq" name="eje_dir_izq" value="cambio"></td>
									<td align="rigth">
										<div class="form-check">
											@foreach($fallas as $falla)
								...
								<tr>
									<td align="center"><input type="radio" required class="form-control" id="eje_dir_der" name="eje_dir_der" value="ok" ></td>
									<td align="center"><input type="radio" required class="form-control" id="eje_dir_der" name="eje_dir_der" value="cambio"></td>
									<td align="rigth">
										<div class="form-check">
											@foreach($fallas as $falla)
					...
					<div class="form-group row " >
						...
						<div class="col-md-12">
							...
							<table width="100%;">
								...
								<tr>
									<td align="center"><input type="radio" required class="form-control" id="eje_motr_izq" name="eje_motr_izq" value="ok" ></td>
									<td align="center"><input type="radio" required class="form-control" id="eje_motr_izq" name="eje_motr_izq" value="cambio"></td>
									<td align="rigth">
										<div class="form-check">
											@foreach($fallas as $falla)
								...
								<tr>
									<td align="center"><input type="radio" required class="form-control" id="eje_motr_der" name="eje_motr_der" value="ok" ></td>
									<td align="center"><input type="radio" required class="form-control" id="eje_motr_der" name="eje_motr_der" value="cambio"></td>
									<td align="rigth">
										<div class="form-check">
											@foreach($fallas as $falla)
					...
					<div class="form-group row " >
						...
						<div class="col-md-12">
							...
							<table width="100%;">
								...
								<tr>
									<td align="center"><input type="radio" required class="form-control" id="susp_eje1" name="susp_eje1" value="ok" ></td>
									<td align="center"><input type="radio" required class="form-control" id="susp_eje1" name="susp_eje1" value="cambio"></td>
									<td align="rigth">
										<div class="form-check">
								...
								<tr>
									<td align="center"><input type="radio" required class="form-control" id="susp_eje2" name="susp_eje2" value="ok" ></td>
									<td align="center"><input type="radio" required class="form-control" id="susp_eje2" name="susp_eje2" value="cambio"></td>
									<td align="rigth">
										<div class="form-check">
											@foreach($fallas as $falla)
					...
					<div class="form-group row " >
						...
						<div class="col-md-12">
							...
							<table width="100%;">
								...
								<tr>
									<td align="center"><input type="radio" required class="form-control" id="tan_drenado" name="tan_drenado" value="ok" ></td>
									<td align="center"><input type="radio" required class="form-control" id="tan_drenado" name="tan_drenado" value="cambio"></td>
									<td align="rigth">
										<div class="form-check">
											@foreach($fallas as $falla)
								...
								<tr>
									<td align="center"><input type="radio" required class="form-control" id="tan_chicotes" name="tan_chicotes" value="ok" ></td>
									<td align="center"><input type="radio" required class="form-control" id="tan_chicotes" name="tan_chicotes" value="cambio"></td>
									<td align="rigth">
										<div class="form-check">
											@foreach($fallas as $falla)
					...
					<div class="form-group row " >
						...
						<div class="col-md-12">
							...
							<table width="100%;">
								...
								<tr>
									<td align="center"><input type="radio" required class="form-control" id="soport_motor" name="soport_motor" value="ok" ></td>
									<td align="center"><input type="radio" required class="form-control" id="soport_motor" name="soport_motor" value="cambio"></td>
									<td align="rigth">
										<div class="form-check">
											@foreach($fallas as $falla)
								...
								<tr>
									<td align="center"><input type="radio" required class="form-control" id="soport_transmi" name="soport_transmi" value="ok" ></td>
									<td align="center"><input type="radio" required class="form-control" id="soport_transmi" name="soport_transmi" value="cambio"></td>
									<td align="rigth">
										<div class="form-check">
											@foreach($fallas as $falla)
